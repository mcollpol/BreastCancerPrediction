...
class OutliersTransformer(BaseEstimator, TransformerMixin):
    ...
    def fit(self, X, y=None):
        ...
        """
        # Mark all values as non-outliers in the initialization.
        self.outliers = pd.DataFrame(False, index=X.index, columns=self.variables)
        ...
        for var in self.variables:
            ...
            if var_std != 0:  # Handling the case where standard deviation is zero.
                ...
                self.outliers[var] = np.abs(z_scores) > self.threshold
